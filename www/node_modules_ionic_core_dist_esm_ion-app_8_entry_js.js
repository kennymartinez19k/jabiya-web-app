(self["webpackChunkJabiya"] = self["webpackChunkJabiya"] || []).push([["node_modules_ionic_core_dist_esm_ion-app_8_entry_js"],{
  ...
  componentDidLoad() {
    {
      rIC(async () => {
        ...
        if (_ionic_global_63a97a32_js__WEBPACK_IMPORTED_MODULE_1__.c.getBoolean('statusTap', isHybrid)) {
          __webpack_require__.e(/*! import() */ "node_modules_ionic_core_dist_esm_status-tap-bdecfebf_js").then(__webpack_require__.bind(__webpack_require__, /*! ./status-tap-bdecfebf.js */ 2634)).then(module => module.startStatusTap());
        }
